    ...
    def _add_rafters(self, assembly: cq.Assembly, x_offset: float = 0, y_offset: float = 0) -> None:
        ...
        for face in ["front", "rear"]:
            ...
            if face == "front":
                ...
                # Adjust target to compensate for rotation geometry (empirical correction updated to -7.853")
                ...
                # Adjust target to compensate for rotation geometry (empirical correction updated to +7.851")
